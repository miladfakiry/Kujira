...
namespace Kujira.Backend.Migrations
{
    ...
    [Migration("20240106162716_AddResponseMessageToServiceRequest2")]
    partial class AddResponseMessageToServiceRequest2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kujira.Backend.Models.ServiceRequest", b =>
                {
            ...
            modelBuilder.Entity("Kujira.Backend.Models.ServiceRequest", b =>
                {
                    b.HasOne("Kujira.Backend.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kujira.Backend.Models.Offer", "Offer")
                        .WithMany()
                        .HasForeignKey("OfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kujira.Backend.Models.User", "ToUser")
                        .WithMany()
