...
namespace Kujira.Backend.Migrations
{
    ...
    [Migration("20231126182358_RollbackRelationshipBetweenAddressAndCompany")]
    partial class RollbackRelationshipBetweenAddressAndCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kujira.Backend.User.Domain.PersonalInformation", b =>
                {
                    b.HasOne("Kujira.Backend.User.Domain.User", "User")
                        ...
                        .HasForeignKey("Kujira.Backend.User.Domain.PersonalInformation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
