...
public class KujiraContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Models.User>(userEntity =>
        {
            ...
            userEntity.Property(i => i.ProfilePicturePath).HasColumnName("UseProfilePicturePath").HasColumnType("character varying").HasMaxLength(255);
        ...
        modelBuilder.Entity<Models.Offer>(offerEntity =>
        {
        ...
        modelBuilder.Entity<Models.Request>(requestEntity =>
        {
    ...
    modelBuilder.Entity<Address>(addressEntity =>
        ...
        modelBuilder.Entity<Models.Company>(companyEntity =>
        {
